...
<body>
	...
	AbreConexao
		conexao.execute("delete from TBVENDEDOR where id="&request("id")&"")
		
		response.Write("<script>alert('Vendedor Removido com Sucesso!');</script>")
            ...
            <div class="layout-container">
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0">Consultar Vendedores</h4>
                        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.asp"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="vendedores_list.asp">Vendedores</a></li>
                        ...
                        <div class="table-responsive">
                            <table class="datatables-demo table table-striped table-bordered">
                                ...
                                <%AbreConexao
								set rs=conexao.execute("select * from TBVENDEDOR order by nome asc")
								%>
                                <tbody>
                                	<%if rs.eof then%>
                                    <tr class="odd gradeX">
                                    ...
                                    <tr class="even gradeC">
                                        ...
                                        <a href="vendedores_list.asp?modo=remover&id=<%=rs("id")%>"><i class="fa fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    <%rs.movenext
									wend
